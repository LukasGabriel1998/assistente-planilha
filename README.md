...
Projeto para cliente leigo, com foco em simplicidade via Telegram:

1. Enviar audio ou digitar texto no bot.
...
- `n8n_api.py`: API HTTP para integracao com n8n.
...
3. Escolha no menu Run and Debug: API n8n se precisar.
...
│   ├── bot_processor.py        # Logica compartilhada Telegram + n8n
...
### 1) Parser isolado (sem interface)
